...
def new_values(email='admin@setapi.local', public_url='http://localhost:8055', bind_host='127.0.0.1', port=8055):
    ...
    return {
        ...
        'SETAPI_DB_POOL_MAX': '20',
        'SETAPI_READ_ENGINE': 'postgrest',
        'SETAPI_POSTGREST_POOL': '10',
        'SETAPI_POSTGREST_THREADS': '1',
        'SETAPI_WS_MAX': '1000',
        'SETAPI_HTTP_CONCURRENCY': '1000',
        'SETAPI_ALLOW_REGISTRATION': 'false',
        'SETAPI_STORAGE_HOSTS': '',
        'SETAPI_SMTP_HOST': '',
        'SETAPI_SMTP_PORT': '587',
        'SETAPI_SMTP_FROM': '',
        'SETAPI_SMTP_USER': '',
        'SETAPI_SMTP_PASSWORD': '',
